...
class Gallery extends Component {
  ...
  clickImg = id => {
    // console.log(id)
    this.setState({
      activeImg: imagesList[id].imageUrl,
      activeAlt: imagesList[id].imageAltText,
    })
  }

  render() {
    const {activeImg, activeAlt} = this.state

    return (
      <div className="bg-container">
        <img className="image" src={activeImg} alt={activeAlt} />
